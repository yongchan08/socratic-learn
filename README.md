...
첫 화면의 학습 로드맵 보관함에서는 여러 로드맵을 만들고 열거나 삭제할 수 있습니다. 카드에는 등록된 PDF 수와 완료 단계가 표시됩니다. 로드맵을 삭제하면 연결된 학습 세션과 최종 리포트는 함께 삭제되며, 공용 파싱·Concept·Question 캐시는 같은 PDF의 재사용을 위해 유지됩니다.
